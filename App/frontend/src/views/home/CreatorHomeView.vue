      ...
      <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="/creatorpage">Creator's Page</a>
              </li>
            </ul>
            <div class="nav-item">
            ...
            <div v-for="playlist in playlists" :key="playlist.playlist_id">
              <div class="card float-start" style="width: 25rem; margin:10px;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"></p>
                  <a :href="`/view_play/${playlist.playlist_id}`" class="btn btn-primary mr-2">View Playlist</a>
